...
You can start writing assets in `dagster_example_pipeline/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `dagster_example_pipeline_tests` directory and you can run tests using `pytest`:

```bash
pytest dagster_example_pipeline_tests
```
